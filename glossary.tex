...
\begin{acronym}
\acro{Ri}[Ri]{Convective Richardson Number:\acroextra{
$Ri_{\Delta} = \frac{gh}{\overline{\theta}_{ML}} \frac{\Delta \theta}{w^{*2}}$ where $\Delta \theta = \overline{\theta}(h_{1})-\overline{\theta}(h_{0})$, or $Ri_{\delta} = \frac{gh}{\overline{\theta}_{ML}} \frac{\delta \theta}{w^{*2}}$ where $\delta \theta = \overline{\theta}_{0}(h)-\overline{\theta}(h)$}}
\end{acronym}
