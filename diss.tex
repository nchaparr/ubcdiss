...
\title{Investigating the Effects of two external Parameters on an idealized Convective Atmospheric Boundary Layer Entrainment Layer using Large Eddy Simulation}
...
\degreetitle{Master of Science (MSc)}
