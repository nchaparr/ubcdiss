...
The magnitudes of \acs{Ri} numbers determined in this and the comparable studies are primarily influenced by the magnitude of the $\theta$ jump. 
...
\begin{tabular}{ p{5cm} p{2cm} p{2cm} p{2cm}}
    %\hline
Publication & \acs{CBL} height & $\Delta \theta$\\ \hline
